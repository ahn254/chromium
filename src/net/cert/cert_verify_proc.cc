...
#include "url/url_canon.h"
    ...
    BUILDFLAG(CHROME_ROOT_STORE_SUPPORTED) || BUILDFLAG(IS_ANDROID) || BUILDFLAG(IS_LINUX)
...
base::Value::Dict CertVerifyParams(
  ...
  return dict;
      ...
      BUILDFLAG(IS_CHROMEOS) || BUILDFLAG(CHROME_ROOT_STORE_ONLY) || BUILDFLAG(IS_ANDROID))
// static
